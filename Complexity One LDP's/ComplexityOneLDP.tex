...
\begin{ex}\rm
Consider the polyhedral divisor defined by $(0,0) \otimes P_0 + (1, 1) \otimes P_1$. With tail cone $\delta = \langle (1,0) , \, (0, 1) \rangle$. We now insist that both rays of the cone are marked but the two dimensional cone is not marked. This can be seen as a toric downgrade of the Atiyah flop, with the quotient corresponding to one of the natural maps to $\mathbb{P}^1$.
\end{ex}
