...
We make the observation that we have classified all log del Pezzo surfaces which do only admit maps to $\mb{F}_0$ or $\mb{F}_1$ ~\ref{Theroem on curves}. This results in only one surface.
...
As this blow up needs to be a $(1,n)$ or a $(n,1)$ weighted blowups the only choices are the following
\[
\begin{tikzpicture}
	...
	\begin{pgfonlayer}{edgelayer}
		...
		\draw [style=Dashed Line] (0.center) to (6.center);
		\draw [style=Dashed Line] (0.center) to (8.center);
		\draw (15.center) to (11.center);
		\draw (11.center) to (13.center);
		\draw (11.center) to (12.center);
		\draw (11.center) to (16.center);
		\draw [style=Dashed Line] (11.center) to (17.center);
		\draw [style=Dashed Line] (11.center) to (19.center);
	\end{pgfonlayer}
\end{tikzpicture}
