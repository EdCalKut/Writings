...
subtorus $T'\subset T$, and then $X$ is a variety of complexity~$k$. (See \S\ref{ToricDowngrades}.)
...
\item $\left[-\frac{1}{2}, \infty \right) \otimes P_1 + \left[ \frac{1}{2}, \infty \right) \otimes P_2 + \left[ \frac{n}{m}, \infty \right) \otimes P_3$ corresponding to $D_n$ singularities.
