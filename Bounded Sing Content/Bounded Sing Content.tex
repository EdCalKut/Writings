...
In addition we can describe the shape of the cascade. In the case where you singulrities are of the form $\frac{1}{p}(1,1)$ the cascades have been classified by CP and the above example. In the case of the singularity being length 2 this has been done above. In the case of your singularity having length 3, then the cascade looks like:
\[
