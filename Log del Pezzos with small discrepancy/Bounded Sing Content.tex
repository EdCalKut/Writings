...
For the general case we split in to cases. Given a basic surface $X$ it is constructed by first blowing up a Hirzebruch surface $k_1$ times at one point and $k_2$ times at another. We classify by these cases

\begin{enumerate}
\item $k_1 = k_2 = 0$: This corresponds to one singularity and we have 
\[
Insert cavey Prince
\]

\item If $k_1 = 1$ and $k_2 = 0$ and there is only one degenerate fiber in the $\mb{P}^1$ fibration induced by the map to the Hirzebruch surface then the singularity is of length 2 and is classified above.

\end{enumerate}

We now call a cascade of type 1 the following diagram:
\[
\begin{tikzpicture}[baseline= (a).base]
\node[scale=.6] (a) at (0,0){
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZARgBoAmAXVJADcBDAGwFcYkQANAfWJAF9S6TLnyEUABgrU6TVuw4ACALwLu4-oJAZseAkXJSaDFm0QgAOuYDGUCDgQChO0UQDMhmSfldg9ALQA1jyBXOR+xHwaTiJ6KO6u0sZyZgCaUVrCumLIBgAsibKmICk8AHq8jhnOsci5pPlGhewlxKXk6dox2QYArAVeZpa0tvYdmS4odX2NAxbmw3YOmp1Z+qQAbP3JxT5gPHzlY9XZdZsz2yXAe+QH7ZUrE7UeSUXcviHEITdHXUQ9pMQtkUAOo-VYof4Jc5FABaYMe63qQPYMLKd2W4xqiPEyLMwLR8KxANxIHxrQqGOORAA7KQcdD2JYbItCdkABx0kn44AQUK3Vk04kMwbWEZLaLg5AcwHC0k+XkRQ73THZRFQzzbVHkgUoWnql6M0Us5VU3VI2VMsU6qWkfVNMyo4AAW32SspvxQHIaGthPhdNza-GkMCgAHN4ERQAAzABOECdSEkIBwECQEU0sfjSAMydTiHElUzCcQ7lz2cLceLpZTSFyFaziDqZcQPXrxabNcQ6zbSH+zepPa7NE7bMHtObAE5Bxzm8QCxnK2myM3XIPiMvO8QbguG+vh3niKud8XD-u03Xj2mc5vW5fEFuz-fu3fiH3NwOX+PN6OX4jZ1OXwnR9yHnaNF3vas83IdMwIbaDgO3WCTw7KCjyQ7Nrygi90MQchIOzVtKD4IA

\begin{tikzcd}
        &               &                  &                                     &                                               &                        & W_1^2 \arrow[r] & \cdots \arrow[r] & W_{o_2}^2 \\
        &               &                  &                                     &                                               & W \arrow[ru] \arrow[r] & W_1^1 \arrow[r] & \cdots \arrow[r] & W_{o_1}^1 \\
X = X_0 & X_1 \arrow[l] & \cdots \arrow[l] & X_{a-k_1-k_2-1} \arrow[l] \arrow[d] & X_{a-k_1-k_2} \arrow[l] \arrow[ru] \arrow[rd] &                        &                 &                  &           \\
        &               &                  & Y \arrow[ld] \arrow[rd]             &                                               & Z \arrow[rd] \arrow[r] & Z_1^1 \arrow[r] & \cdots \arrow[r] & Z_{m_1}^1 \\
        &               & Y_1^1 \arrow[d]  &                                     & Y_1^2 \arrow[d]                               &                        & Z_1^2 \arrow[r] & \cdots \arrow[r] & Z_{m_2}^2 \\
...
\end{tikzpicture}
\]
This enables us to enumerate the following cases
\begin{enumerate}
\item $k_1 \neq 0$ and $k_2 \neq 0$ and $a-k_1-k_2 >2$ . This lies in a cascade of type 1 and starts from $X_0$.


\item The $Y_{n_1}^1$ or $Y_{n_2}^2$ are surfaces such that $k_1 = 1$ and $k_2 = 0$ and there is only one degenerate fiber in the $\mb{P}^1$ fibration induced by the map to the Hirzebruch surface. 

\item The $Z_{m_1}^1$, $Z_{m_2}^2$, $W_{o_1}^1$ and $W_{o_2}$ are surfaces such that $k_1 = 1$ and $k_2 = 0$ and there are two degenerate fibers in the $\mb{P}^1$ fibration induced by the map to the Hirzebruch surface. 
\end{enumerate}
Other cases lie in a cascade of type 2 which is represented by the following diagram:
\[
\begin{tikzpicture}[baseline= (a).base]
\node[scale=.79] (a) at (0,0){
% https://tikzcd.yichuanshen.de/#-dhXCD8KQwKAAc3gRFAADMAE4QFGICQgHC4xA1DSU6lIAz0xnkbKsmnuTnsnlUmnxAWIcIs4VIIpi2JCtmIZpigrykU0BlIADsqq16sZAA4dYgZRrEABOI1K03EbmShVmvVIYjM8lSpl062ZO00-WOpkS10K51+4hy71OjnWlWUPhAA
\begin{tikzcd}
X = X_0 & X_1 \arrow[l] & \cdots \arrow[l] & X_{a-k+2-3} \arrow[l] & X_{a-k_1-2} \arrow[l] \arrow[d] & X_{a-k_1-1} \arrow[l] \arrow[d] & X_{a-k_1} \arrow[l] \arrow[d] \\
        &               &                  &                       & Y_1 \arrow[d]                   & Z_1 \arrow[d]                   & W_1 \arrow[d]                 \\
...
This enables us to enumerate the following cases
\begin{enumerate}
\item $k_1 > 0$ and $k_2= 0$ and there is only one degenerate fiber. This lies in a cascade of type 2 starting from $X_0$ or from $Y_n$.

\item Two non degenerate fibers but $a - k_1 - k_2 = 0$ or $1$. This lies in a cascade of type 2 starting from $Z_m$

\item Two non degenerate fibers but with $k_1 >1$ and $k_2 = 0$
\end{enumerate}
There are a couple of final sporadic cases 
\begin{enumerate}
\item $k_1 = k_2 = 0$ and there are two non degenerate fibers. Then the singularity of  This has the following cascade 
\[
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZABgBpiBdUkANwEMAbAVxiRAA0ACAXk-YH1iIAL6l0mXPkIoAjOSq1GLNgJkixIDNjwEiAJnnV6zVohAAdcwGMoEHAlHjtUogGZDikyv7A6AWgBrfhlA-j0-GWF1J0ldFAAWD2NlMwFfUJCgvSjHTQkdaWR3GQVk0xAATWi85zjkAz1SpXKK4IA9NVytWMLExqNmtlaZNr1q7oL9UlcmrzNLGlt7cfyXBOnZlItzRbsHDQm1+tJ4zZafMGDhDpXa3pOzoYuw67HhBRgoAHN4IlAAMwAThAALZIOQgHAQJBkTwpMBMBgMagMOgAIxgDAACqs4iAGDB-jhqkDQUgDJDoYgIWUkAikSj0ZicXc2ASiSTgWDEO5KeSBnN6cj8UzsbjpPjCcTcqTubyoUgAKwC+GI4WojFi1lmdnSjSypCJPk8lWmIWMzUsnpsqWcsmIZXGgBsprpaotzPFNo5Mq5SuoCsQAHZXYhzSLLV6dbbffaXcaAByh8Maz3ayU+-V+4MBqkATmT7ojaet0czAOzSeNMlhtLDRdTWtLGb1FftBerNMG9YZxabkzL0oowiAA
\begin{tikzcd}
...
\end{tikzcd}
\]
The $Y_i$ are of the form $k_2 = 0$ and $k_1 = 1$ with one degenerate fiber.
...
\end{tikzcd}
\]
So in particular this arises from a basic surface with $k_2 = 0$, $k_1 = 1$ and the strict transform of only one fiber becoming an exceptional curve. This concludes the first case.
...
After $a_1-k$ blowups we get a straight chain of blowdowns arising from floating $-1$ curves intersecting $-1$ curves coming out of $E_k$. None of these new $-1$ curves intersect each other, but they intersect every single one the curves introduced by blowing up. Hence we get a straight line cascade. 


After $a_1-k+1$ blowups we also get $-1$ curves intersecting the fiber $E_{k-1}$. These curves intersect the floating curves arising the case above once. So upon blowdown these two cascades cannot intersect. This gives another straight line cascade. 

The final case behaves a little differently 
\end{proof}
