...
\begin{tikzpicture}[scale = 0.5]
	\begin{pgfonlayer}{nodelayer}
		...
		\node [style=none] (33) at (-1, -1.5) {-3};
		\node [style=none] (34) at (0.75, -1.5) {-3};
		\node [style=none] (35) at (-3.75, -5.25) {-1};
		\node [style=none] (36) at (-0.75, -5.25) {-1};
		\node [style=none] (37) at (1, -5.25) {-1};
